							...
							{cartItems.map((item) => (
								...
								>
									...
									<div className="w-40 h-40 bg-gray-100 rounded-lg flex items-center justify-center">
										<img className="h-32 object-contain" src={item.image} alt={item.title} />
									</div>
									{/* Product details */}
									<div className="flex-1 flex flex-col justify-between">
										<div>
											<span className="inline-block bg-blue-100 text-blue-600 text-xs px-3 py-1 rounded-full capitalize mb-2 font-semibold">{item.category}</span>
