...
const ProductCard = ({ product }) => {
	...
	return (
		<div className="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden border border-gray-300 hover:-translate-y-2">
			{/* product image */}
			...
			<div className="p-5 flex flex-col gap-3">
				{/* category */}
				<span className="w-fit bg-blue-100 text-blue-700 font-semibold px-3 py-1 rounded-full capitalize/*  */">
					{product.category}
				</span>
