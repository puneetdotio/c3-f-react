...
export default function ProductCard({product}) {
	...
	return (
		<div className="w-full max-w-sm overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-md transition duration-300 hover:-translate-y-1 hover:shadow-xl">
			...
			<div className="space-y-4 p-5">
				...
				<div className="flex items-center justify-between border-t border-slate-200 pt-4">
					...
					<button onClick={() => setCartItems((prev) => [...prev, product])} className="rounded-xl bg-slate-900 px-4 py-2 text-sm font-medium text-white transition hover:bg-slate-800">
						Add to Cart
					</button>
				</div>
			</div>
