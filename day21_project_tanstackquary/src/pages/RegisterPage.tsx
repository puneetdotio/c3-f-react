...
const RegisterPage = () => {
	const { register, handleSubmit, errors, registerForm, navigate } = useAuth();
		...
		<div className="min-h-screen bg-gray-100 flex items-center justify-center px-4">
			<div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
				...
				<form onSubmit={handleSubmit(registerForm)} className="space-y-5">
					...
					<button
						className="w-full bg-blue-600 hover:bg-blue-700 py-3 text-white rounded-lg cursor-pointer font-semibold transition duration-300"
						type="submit"
					>
						Register
					</button>
